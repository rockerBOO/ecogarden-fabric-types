...
export type TMatrixCache = {
  key: number[];
  value: TMat2D;
};
export type OriginX = "left" | "center" | "right" | number;
export type OriginY = "top" | "center" | "bottom" | number;
...
interface IObservable<T, Events extends CanvasEvent | ObjectEvent> {
  /**
   * Observes specified event
   * @param eventName Event name (eg. 'after:render')
   * @param handler Function that receives a notification when an event of the specified type occurs
   */
  on(eventName: Events, handler: (e: IEvent<MouseEvent>) => void): T;
...
export class Pattern {
  ...
  constructor(options?: Partial<IPatternOptions>);
  /**
...
export class Shadow {
  constructor(options?: Partial<IShadowOptions> | string);
  initialize(options?: Partial<IShadowOptions> | string): Shadow;
  /**
...
export interface StaticCanvas
  extends IObservable<StaticCanvas, CanvasEvent>,
...
export class StaticCanvas {
   ...
   * @chainable
   */
  setViewportTransform(vpt: TMat2D): Canvas;
...
export class Ellipse {
  constructor(options?: Partial<IEllipseOptions>);
  /**
   * Returns horizontal radius of an object (according to how an object is scaled)
   */
  getRx(): number;
...
export class ActiveSelection {
   ...
   * @param [options] Options object
   */
  constructor(objects?: Object[], options?: Partial<IObjectOptions>);
  /**
   * Constructor
...
interface IImageOptions extends IObjectOptions {
   ...
   */
  crossOrigin: "" | "anonymous" | "allow-credentials";
  /**
...
export class Line {
   ...
   * @param [options] Options object
   */
  constructor(points?: number[], objObjects?: Partial<ILineOptions>);
  /**
   * Returns svg representation of an instance
   * @return {Array} an array of strings with the specific svg representation
   * of the instance
...
export interface Object
  extends IObservable<Object, ObjectEvent>,
    IObjectOptions,
...
export class Object {
   ...
   *  mtr?: Control;
   */
  controls: { [key: string]: Control<Object> };
   ...
   * @default 0
   */
  readonly __corner: string | number | any;

  constructor(options?: Partial<IObjectOptions>);
  initialize(options?: Partial<IObjectOptions>): Object;
   ...
   */
  setPositionByOrigin(
    pos: Point | { x: number; y: number },
    originX: "left" | "center" | "right" | number,
    originY: "left" | "center" | "right" | number,
  ): void;
...
export class Path {
   ...
   * @param [options] Options object
   */
  constructor(path?: string | Point[], options?: Partial<IPathOptions>);
...
export class Polygon extends Polyline {
   ...
   * @param [options] Options object
   */
  static fromElement(element: SVGElement, options?: IObjectOptions): Polygon;
  /**
...
export class Polyline extends Object {
  ...
  _setPositionDimensions(options: Partial<IPolylineOptions> = {}): void;
   ...
   * @param [options] Options object
   */
  static fromElement(element: SVGElement, options?: IObjectOptions): Polyline;
  /**
...
export class Rect extends Object {
   ...
   * @param [options] Options object
   */
  constructor(options?: Partial<IRectOptions>);
  /**
...
export class IText extends Text {
  readonly _dimensionAffectingProps: DimensionAffectingProps[];
   ...
   * @param [options] Options object
   */
  constructor(text: string, options?: Partial<ITextOptions>);
  /**
...
export class Textbox extends IText {
   ...
   * @param [options] Options object
   */
  constructor(text: string, options?: Partial<ITextboxOptions>);
  /**
   * Returns true if object has a style property or has it ina specified line
   * @param {Number} lineIndex
   * @return {Boolean}
...
export class Triangle extends Object {
   ...
   * @param [options] Options object
   */
  constructor(options?: Partial<ITriangleOptions>);
  /**
   * Returns SVG representation of an instance
   * @param [reviver] Method for further parsing of svg representation.
   * @return svg representation of an instance
...
interface IAllFilters {
  ...
  Gamma: {
     ...
     */
    new (options?: {
      gamma?: [number, number, number] | undefined;
    }): IGammaFilter;
    /**
     * Returns filter instance from an object representation
     * @param object Object to create an instance from
...
interface IUtilMisc {
   ...
   */
  multiplyTransformMatrices(a: TMat2D, b: TMat2D): TMat2D;
...
export class Control<T extends Object> {
...
export interface Transform<T extends Object> {
  target: T;
  action: string;
